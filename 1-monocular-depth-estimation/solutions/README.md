...
* For details on how dataset is created?, refer [(Link)](../dataset_creation/)

Let's have quick summary of dataset and visulaization for each kind of images

**Dataset statistics**

Notebook: **dataset_statistic_updated.ipynb**[(Link)](dataset_statistic.ipynb):

<p align="center"><img style="max-width:800px" src="../dataset_creation/doc_images/dataset_statistics_updated.png" alt="Dataset statistics"></p>
...
* Training Tiny CNN model for different Loss function
  ...
  * This model is trained for four different loss functions and their prediction results and accuracy are compared.
	- Solution-1: Loss: BCEwithLogitsLoss [(Link)](Main_CNN_BCEWithLogitsLoss_ShortData.ipynb)
	- Solution-2: Loss: SmoothL1Loss [(Link)](Main_CNN_SmoothL1Loss_ShortData.ipynb)
	- Solution-3: Loss: MSELoss [(Link)](Main_CNN_MSELoss_ShortData.ipynb)
	- Solution-4: Loss: SSIMLoss [(Link)](Main_CNN_SSIMLoss_ShortData.ipynb)
* Accuracy Calculation: EVA4S15_AccuracyCalculation [(Link)](AccuracyCalculation.ipynb)
* Building Final model:
  * Model-1: Custom CNN Architecture: 
  	* Model Arch: DMNet_CNN_V1.py [(Link)](models/depthmap/DMNet_CNN_V1.py):
	* Solution Notebook: EVA4S15_Main_CNN_V1_BCEWithLogitsLoss_400k.ipynb [(Link)](Main_CNN_V1_BCEWithLogitsLoss_400k.ipynb)
  * Model-2: Custom Resnet Architecture 
	* Model Arch: DMNet_Resnet.py [(Link)](models/depthmap/DMNet_Resnet.py):
	* Solution notebook, EVA4S15_Main_Resnet_BCELogitsLoss_400k_Part2.ipynb [(Link)](Main_Resnet_BCELogitsLoss_400k_Part2.ipynb)
...
## Getting thing right, First Notebook? [(Link)](Main_CNN_BCEWithLogitsLoss_ShortData.ipynb)
...
*Notebook: EVA4S15_loss_algo_compare.ipynb*[(Link)](loss_algo_compare.ipynb)
...
This model is trained for four different loss functions and their prediction results and accuracy are compared.
- Solution-1: Loss: BCEwithLogitsLoss[Notebook: Main_CNN_BCEWithLogitsLoss_ShortData][(Link)](Main_CNN_BCEWithLogitsLoss_ShortData.ipynb) 
- Solution-2: Loss: SmoothL1Loss[Notebook: Main_CNN_SmoothL1Loss_ShortData] [(Link)](Main_CNN_SmoothL1Loss_ShortData.ipynb) 
- Solution-3: Loss: MSELoss[Notebook: Main_CNN_MSELoss_ShortData] [(Link)](Main_CNN_MSELoss_ShortData.ipynb) 
- Solution-4: Loss: SSIMLoss[Notebook: Main_CNN_SSIMLoss_ShortData] [(Link)](Main_CNN_SSIMLoss_ShortData.ipynb) 
...
For more detail on accuracy calculation and technique, refer AccuracyCalculation.ipynb[(Link)](AccuracyCalculation.ipynb)
...
**Refer Notebook:** EVA4S15_AccuracyCalculation.ipynb[(Link)](AccuracyCalculation.ipynb)
...
* Model is trained in two part:
  * Part1: EVA4S15_Main_Resnet_BCELogitsLoss_400k_Part1.ipyn [(Link)](Main_Resnet_BCELogitsLoss_400k_Part1.ipynb)
    * Model is executed for 6 epochs and its learned weight and optimizer states are saved
  * Part2 : EVA4S15_Main_Resnet_BCELogitsLoss_400k_Part2.ipynb [(Link)](Main_Resnet_BCELogitsLoss_400k_Part2.ipynb)
...
**Solution Notebook:** Main_Resnet_BCELogitsLoss_400k_Part2.ipynb [(Link)](Main_Resnet_BCELogitsLoss_400k_Part2.ipynb)
