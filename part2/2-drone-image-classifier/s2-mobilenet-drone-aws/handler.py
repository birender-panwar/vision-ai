...
MODEL_PATH = os.environ['MODEL_PATH'] if 'MODEL_PATH' in os.environ else 'session2/mobilenet_drone.pt'
...
def classify_image(event, context):
    try:
        ...
        print(f'Image classification: {class_list[prediction]}, code: {prediction}')
        ...
        return {
            ...
            "body": json.dumps({'file': filename.replace('"', ''), 'predicted': prediction, 'classname' : class_list[prediction]})
        }
    except Exception as e:
        print(repr(e))
        return {
